...
使用:
  ...
  python3 tools/simulate_emg_from_bicep.py --label compensating --host 10.29.10.224
...
_WAVEFORM = {
    "standard": [
        # Demo calibration note:
        # The current bicep GRU was trained from the small April-12 capture set.
        # In that set "golden" carries a relatively high comp channel baseline,
        # so simulator labels must follow the trained domain rather than the
        # intuitive muscle semantics used in early V7 scripts.
        (0.00, 12.0, 24.0),
        (0.20, 22.0, 36.0),
        (0.50, 34.0, 48.0),
        (0.75, 40.0, 58.0),
    ...
    "non_standard": [
        # Lazy / insufficient range: high target with only moderate comp, paired
        # with the shallow fake-pose peak in P1 tests.
        (0.00, 20.0, 10.0),
        (0.30, 45.0, 14.0),
        (0.50, 68.0, 18.0),
        (0.75, 82.0, 22.0),
    ...
    "compensating": [
        # Captured "bad" curl maps to CLASS_LAZY/compensating for this model:
        # moderate target, quiet comp channel.
        (0.00, 10.0,  2.0),
        (0.15, 18.0,  4.0),
        (0.35, 27.0,  6.0),
        (0.55, 34.0,  8.0),
