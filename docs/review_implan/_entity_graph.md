...
- GRU model TRAINED (2026-04-12, bicep_curl 3-class: golden/lazy/bad)
- Vosk ABI crash on board Python 3.7 (using Google ASR fallback)
- AI similarity confidence stuck at 0.991 for all actions (inference data flow issue)
- FSM needs fix: should judge after complete rep, not mid-motion
